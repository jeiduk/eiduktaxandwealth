...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border bg-white text-card-foreground shadow-[0_2px_8px_rgba(30,58,95,0.08)] transition-all duration-200 hover:shadow-[0_4px_16px_rgba(30,58,95,0.12)] hover:-translate-y-0.5",
      className
    )}
    {...props}
  />
